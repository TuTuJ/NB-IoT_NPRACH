...
public class nprach_demo1 extends TimerTask{
	...
	int s1 = 12, s2 = 24, s3 = 36, s4 = 48; //Define subcarrier number
	int[] subcarrier_CE0 = new int [s2];
	int[] subcarrier_CE1 = new int [s1];
	int[] subcarrier_CE2 = new int [s1];
	int CE0_dy_subcarrier = 24, CE1_dy_subcarrier = 12, CE2_dy_subcarrier = 12;
	static int CE0_wait_comming = 50, CE1_wait_comming = 50, CE2_wait_comming = 50; //initial
	static int CE0_afterACB, CE1_afterACB, CE2_afterACB = 0;
	int CE0_Success_Count, CE1_Success_Count, CE2_Success_Count = 0;
